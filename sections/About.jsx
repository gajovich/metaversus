  ...
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div
      ...
      <motion.p
        ...
        only <span className="font-extrabold text-white">VR</span> devices you can easily{' '}
        <span className="font-extrabold text-white">explore</span> the metaverse world you want,
